...
var app = (function () {
    ...
    // pass default values to products store as writable arguments
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 56, 4, 1128);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 49, 2, 870);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$3, 50, 2, 889);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$3, 48, 0, 863);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 41, 6, 687);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text("\n>");
    			add_location(h1, file$2, 36, 2, 537);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$2, 37, 2, 553);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$2, 35, 0, 525);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let $cartItems;
    	validate_store(customCartStore, 'cartItems');
    	component_subscribe($$self, customCartStore, $$value => $$invalidate(0, $cartItems = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	$$self.$capture_state = () => ({ CartItem, cartItems: customCartStore, $cartItems });
    	return [$cartItems];
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 49, 4, 779);
    			attr_dev(h2, "class", "svelte-9ht2za");
    			add_location(h2, file$1, 50, 4, 800);
    			attr_dev(p, "class", "svelte-9ht2za");
    			add_location(p, file$1, 51, 4, 821);
    			add_location(div0, file$1, 48, 2, 769);
    			add_location(div1, file$1, 53, 2, 853);
    			attr_dev(div2, "class", "product svelte-9ht2za");
    			add_location(div2, file$1, 47, 0, 745);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function addToCart() {
    		//cartItems.set([]);
    		customCartStore.addItem({ id, title, price });
    	}
    ...
    // (16:2) {#each $productItems as product (product.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*$productItems*/ 1) product_changes.id = /*product*/ ctx[1].id;
    			if (dirty & /*$productItems*/ 1) product_changes.title = /*product*/ ctx[1].title;
    			if (dirty & /*$productItems*/ 1) product_changes.price = /*product*/ ctx[1].price;
    			if (dirty & /*$productItems*/ 1) product_changes.description = /*product*/ ctx[1].description;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(16:2) {#each $productItems as product (product.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let each_1_lookup = new Map();
    	let current;
    	let each_value = /*$productItems*/ ctx[0];
    	validate_each_argument(each_value);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 14, 2, 226);
    			attr_dev(section, "class", "svelte-o8blwk");
    			add_location(section, file, 13, 0, 214);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$productItems*/ 1) {
    				each_value = /*$productItems*/ ctx[0];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let $productItems;
    	validate_store(products, 'productItems');
    	component_subscribe($$self, products, $$value => $$invalidate(0, $productItems = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	$$self.$capture_state = () => ({ Product, productItems: products, $productItems });
    	return [$productItems];
    }
